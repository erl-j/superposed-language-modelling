...
model = UnetModel.load_from_checkpoint(
    "../checkpoints/unique-sun-17/last copy.ckpt",
    map_location=device,
)
#%%
...
print(a.shape)
s = model.generate(a, sampling_steps=100, temperature=0.9)
...
# Generate a sequence
sequence = model.generate(a, temperature=0.99)
# %%
