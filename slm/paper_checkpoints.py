checkpoints = {
    "mlm": "checkpoints/magic-forest-321/epoch=78-step=256197-val/loss_epoch=0.29299.ckpt",
    "slm": "checkpoints/easy-night-320/epoch=102-step=334029-val/loss_epoch=0.12267.ckpt",
}
