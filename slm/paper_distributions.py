...
mlmrs = "checkpoints/trim-water-280/epoch=127-step=184704-val/loss_epoch=0.14.ckpt"

ckpt = "checkpoints/brisk-paper-258/epoch=23-step=86592-val/loss_epoch=1.71.ckpt"

mlmrs = EncoderOnlyModel.load_from_checkpoint(
    ROOT_DIR + ckpt,
    map_location=device,
    avg_positional_encoding=True,
)

slm = "checkpoints/trim-water-280/epoch=127-step=184704-val/loss_epoch=0.14.ckpt"
...
for scale in scales:
    ...
    for idx in highlight_idx:
        plt.gca().add_patch(
            plt.Rectangle(
                (0, pitch_token_idxs.index(idx) - 0.5),
                1,
                1,
                fill=True,
                color="red",
