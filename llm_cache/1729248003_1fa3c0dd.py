# This edit keeps everything the same but add some 808 (midi pitch 35)
def build_constraint(e, ec, n_events, beat_range, pitch_range, drums, tag, tempo):
                            '''
                            To generate a funk beat with snares on the 2 and 4, triplets in the last bar, and add some 808 bass drum (MIDI pitch 35).
                            '''
                            e = []
                            # remove all drums
                            ...
                            # add 8 808 bass drum hits (MIDI pitch 35)
