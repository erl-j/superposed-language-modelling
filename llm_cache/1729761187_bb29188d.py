# Create a house beat with open hihats on the upbeats.
def build_constraint(e, ec, n_events, beat_range, pitch_range, drums, tag, tempo):
                            '''
                            We want to create a house beat with a typical four-on-the-floor kick pattern,
                            snares on the 2 and 4, closed hi-hats on every beat, and open hi-hats on the upbeats.
                            '''
                            e = []
                            ...
                            # Set open hi-hats on the upbeats (off-beats)
                            for beat in range(16):
                                e += [
                                    ec()
