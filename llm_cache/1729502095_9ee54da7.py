...
def build_constraint(e, ec, n_events, beat_range, pitch_range, drums, tag, tempo):
                            ...
                            for bar in range(4):
                                ...
                                for note in chord:
                                    e.append(
                                        ...
                                        .intersect(ec().velocity_constraint(60, 80))  # Softer velocity
                                        .force_active()
                                    )
                            ...
                            e += [
                                ...
                                .intersect(ec().velocity_constraint(50, 70))
                                for _ in range(10)
                            ]
            
                            # Set tag to newage or classical for a calmer feel
                            e = [ev.intersect({"tag": {"newage", "classical"}}) for ev in e]
