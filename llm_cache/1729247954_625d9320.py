# This edit keeps everything the same but add some more claps
def build_constraint(e, ec, n_events, beat_range, pitch_range, drums, tag, tempo):
                            '''
                            To generate a funk beat with snares on the 2 and 4, triplets in the last bar, and additional claps.
                            '''
                            e = []
                            # remove all drums
                            ...
                            # add claps (39 is the MIDI note for clap)
                            e += [ec().intersect({"pitch": {"39 (Drums)"}}).force_active() for _ in range(8)]
